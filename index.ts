...
app.use('*', cors({
  origin: ['http://localhost:4200', 'https://uncoverrr.vercel.app', 'https://uncoverrr-git-pwa-integration-daniel-glovers-projects.vercel.app', 'https://uncoverrr-git-dev-daniel-glovers-projects.vercel.app'], // Your frontend URLs
